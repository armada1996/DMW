...
Original file is located at
    https://colab.research.google.com/drive/1j5BH0QBsBdyxARyZTTBBiYY48trJgKLe
"""
...
import io
df = pd.read_csv(io.BytesIO(data_to_load['oasis_longitudinal.csv']))
...
#scatter plot between EDUC and SES
x = df['EDUC']
y = df['SES']
...
Y = df_dropna['Group'].values # Target
...
#  after dropping missing value rows
best_score=0
kfolds=5 
